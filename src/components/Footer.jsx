...
const Footer = () => {
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/chiragtomar58",
      icon: <RiLinkedinFill className="text-2xl" />,
    },
    {
      name: "Gmail",
      url: "mailto:chiragtomar370@gmail.com",
      icon: <RiMailFill className="text-2xl" />,
    },
    {
      name: "GitHub",
      url: "https://github.com/Chiragtomar58/GTA-WEB",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center text-white/60 mt-6">
          <p className="font-[Helvetica_Now_Display]">
            © {new Date().getFullYear()} Chirag Tomar. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
